...
int main(void)
{
  ...
  MX_USART2_UART_Init();
  /* USER CODE BEGIN 2 */
  uint8_t test[] = "UART ALIVE\r\n";
HAL_UART_Transmit(&huart1, test, 12, HAL_MAX_DELAY);
HAL_Delay(500);
 printmsg("BL_DEBUG_MSG: UART Test\n\r");
HAL_UART_Transmit(&huart1, test, 12, HAL_MAX_DELAY);
...
//uint8_t dbg[] = "PRINTMSG CALLED\r\n";
   // HAL_UART_Transmit(&huart1, dbg, 17, HAL_MAX_DELAY);
